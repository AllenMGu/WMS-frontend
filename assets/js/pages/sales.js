 ...
 * SPA 模块：window.PAGES['sales'] = { title, icon, desc, init, fn } */
(function () {
    'use strict';
    ...
    window.PAGES['sales'] = {
        ...
        desc: '销售出库、拣货、复核与发运',
        init: pageInit,
        fn: { submitSO, approveSO, allocateSO, pickSO, prepareShipment, reviewShipment, dispatchShipment, cancelSO },
    };
    window.pageInit = pageInit; // 兼容直接访问旧页面 sales.html
})();
