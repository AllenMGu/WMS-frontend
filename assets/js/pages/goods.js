...
function renderTable() {
    ...
    tbody.innerHTML = goods.map(g => `
        <tr>
            ...
            <td class="actions">
                <button class="btn btn-link btn-sm" onclick="openGoodsModal(${g.id})"><i class="fa fa-edit"></i> 编辑</button>
                <button class="btn btn-link btn-sm" style="color:var(--red-600)" onclick="deleteGoods(${g.id})"><i class="fa fa-trash"></i> 删除</button>
            </td>
